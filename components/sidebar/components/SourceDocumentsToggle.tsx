...
const SourceDocumentsToggle: React.FC<SourceDocumentsToggleProps> = ({
    ...
    return (
        <Switch.Group as="div" className="flex flex-row items-center justify-between align-center">
            <span className="flex flex-col">
                <Switch.Label as="span" className="text-xs sm:text-sm font-medium leading-6 text-blue-400" passive>
